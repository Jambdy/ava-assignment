...
class CreditHistoryChart extends StatefulWidget {
  const CreditHistoryChart({super.key, required this.creditScoreGraphData});

  final CreditScoreGraphData creditScoreGraphData;

  @override
  CreditHistoryChartState createState() => CreditHistoryChartState();
}

class CreditHistoryChartState extends State<CreditHistoryChart>
